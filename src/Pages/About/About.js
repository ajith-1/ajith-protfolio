  ...
  return (
    <>
      <Container sx={{display:'flex',alignItems:'cener',justifyContent:'center',height:'100vh',flexDirection:'column'}}>
        <Typography variant='h2' textAlign={'center'} data-aos="fade-up" data-aos-duration='700'>About Me</Typography> 
        <Typography variant='h5' textAlign={'center'} mt={6} data-aos="fade-up" data-aos-duration='900'>Hi, I'm Ajith Kumar, a passionate front-end developer based in Bangalore.
